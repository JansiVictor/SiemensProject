Feature: TST027_SFGNMEX15
        ...
        Scenario: Going through Install Kit - Gas section
                ...
                When I fill the SFENMEX15 Gas Install Kit section fields with values
                Then I should see SFENMEX15 GICOM Message section

        Scenario: Going through "GICOM Message" GAS section
                Given the SFENMEX15 GICOM Message section
                When I fill the SFENMEX15 GICOM Message section fields with values
        ...
        Scenario: Going through "Install PPMID" GAS section
                ...
                When I fill the SFENMEX15 Install PPMID section fields with values
                Then I should see SFENMEX15 PPMID Comissioning section

        Scenario: Going through PPMID Comissioning Section
                Given the SFENMEX15 PPMID Comissioning section
                When I fill the SFENMEX15 PPMID Comissioning section fields with values
                Then I should click SFENMEX15 Submit button to complete the job section
        ...
        Scenario: Going through Device Binding and Comissioning Section
                ...
                When I fill the SFENMEX15 device binding section fields with values
        ...
        Scenario: Going through "Perform Smart Meter Education and Demonstration "
                ...
                When I fill the SFENMEX15 Perform Smart Meter Education and Demonstration  fields with values
                Then I should see SFENMEX15 Summary of Job and Smart literature left onsite section

        Scenario: Going through Smart literature left onsite section
                Given the SFENMEX15 Smart literature left onsite section
