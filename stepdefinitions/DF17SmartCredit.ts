...
import {
	DF17SmartCredithomePageObject
} from "../pages/DF17SmartCredithomePage";
import {
	DF17SmartCreditAppointmentListPageObject
} from "../pages/DF17SmartCreditAppointmentListPage";
import {
	DoorStepPageObject
...
import {
	DF17SmartCreditJobCompletionPageObject
} from "../pages/DF17SmartCreditJobCompletion";
import {
	config
} from "../config/config";
import {
...
const home: DF17SmartCredithomePageObject = new DF17SmartCredithomePageObject();
const applist: DF17SmartCreditAppointmentListPageObject = new DF17SmartCreditAppointmentListPageObject();
...
const df17smartcreditComplete: DF17SmartCreditJobCompletionPageObject = new DF17SmartCreditJobCompletionPageObject();
