  ...
  * @Description  Automation for FAULTY18 Workflow
    */
    ...
    public async clickonPPMIDRmvl() {
        await utility.wait(utility.very_low);
        if (await this.ppmidremoval.isDisplayed()) {
            await this.ppmidremoval.click();
        }
    }
  ...
  * @Description  Automation for FAULTY18 Workflow
    */
    ...
    public async CurrentMeterElec() {
        await utility.wait(utility.very_low);
        await this.currentEleccap.getText().then(function (currentEleccapTxt) {
            console.log("Current Meter" + currentEleccapTxt);
        });
    }
