Feature: SFEEXCH23 - InstallAndLeave Workflow
    ...
    Scenario: Going through "REMOVE METER" section for EXCH23
        ...
        When I fill the InstallAndLeave Remove meter values for EXCH23
    ...
    Scenario: Going through Replace CommsHubNoWan section
        ...
        Then I click the EXCH23 Elec Install Submit Button
        And I should see DEVICE BINDING and COMMISSIONING sec for EXCH23
