Feature: SFGEXCH22 - InstallAndLeave Workflow
        ...
        Scenario: Going through "Post Installation GAS" GAS section
                ...
                When I fill the EXCH22 InstallLeave Post Installation GAS section fields with values
        ...
        Scenario: Going through Replace CommsHubNoWan section
                ...
                When I fill the EXCH22 InstallLeave Replace CommshubNoWan details fields with values
        ...
        Scenario: Going through "INSTALL PPMID" section
                ...
                And ExchTwTwo I should see DEVICE BINDING and COMMISSIONING sec
