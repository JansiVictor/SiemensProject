...
export class RemoveTRADPageObject {
    ...
    //CGP added Determine faulty activity

    //public confirmgasmeterOnsupply: ElementFinder; can be used
  ...
  * @Description  Automation for FAULTY18 Workflow
    */
    ...
    public async fillElecmeterRemoval() {
        ...
        await utility.wait(2000); // Change Later
