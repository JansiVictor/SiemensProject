Feature: TST035_AbortGasRisk_DFFLTY20SMETS2
    ...
    Scenario: Going through "INITIAL POLARITY CHECK - AT METER AND CUT OUT" section
        ...
        And I click on fltynineteen SUBMIT button
    ...
    Scenario: Going through "REMOVE METER" section
        ...
        When TST35 I fill the field023 with the Value023
        Then I clk fltynineteen remove meter NEXT SECTION button
