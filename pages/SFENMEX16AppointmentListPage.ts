...
export class SFENMEX16AppointmentListPageObject {
    ...
    constructor() {
        ...
        this.clickSubmit = element(by.xpath('(//button[@id="btn1"])[2]'));
    ...
    public async meterCutOutnextSection_SFENMEX15() {
        await expect(this.clickSubmit_SFENMEX15.isPresent());
