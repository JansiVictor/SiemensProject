...
export class RiskAssessmentForGasPageObject {
    ...
    public gasRiskAssessmentNextSectionBtn: ElementFinder;
    ...
    constructor() {
        ...
        this.gasRiskAssessmentNextSectionBtn = element(by.xpath("//div[@class='collapse in']//button[@id='btnNextComm']"));
    }
    ...
    public async clickOnriskAssessGasBtn() {
        await this.riskAssessGas.isPresent();
        await this.riskAssessGas.click();
    }
