...
this.DFFLTY20TRADSuspendStatusLink = element.all(by.xpath('//*[starts-with(@id,"SuspendedJobFAULTY 20 Non S2")]'));
	...
	this.Ex20selectLink = element.all(by.xpath('//span[starts-with(@id,"SelectJobEXCHANGE 20 SF SMETS2")]'));
	...
	this.selectLink = element.all(by.xpath('//span[starts-with(@id,"SelectJobEXCHANGE 21 DF SMETS2"]'));
	...
	this.SFGASINST14 = element.all(by.xpath('//span[starts-with(@id,"SelectJobINST14 DF SMETS")]'));
