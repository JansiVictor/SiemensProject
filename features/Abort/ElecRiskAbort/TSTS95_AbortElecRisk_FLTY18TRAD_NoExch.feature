Feature: TST95_AbortElecRisk_FLTY18TRAD_NoExch Workflow
	...
	Scenario: Going through the Reason codes popup
		...
		Then I should see the ELEC Risk Aborted status for the workorder "SFGFLTY18TRAD" on the appointments page
