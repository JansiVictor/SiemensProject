...
export class SFGFLTY18TRADJobCompletionPageObject {
    ...
    public currentPPMIDText: ElementFinder;
    public PPMIDOnsite: ElementFinder;
    ...
    constructor() {
        ...
        this.currentPPMIDText = element(by.id('Title_currentIhdPpmid'));
        ...
        this.PPMIDOnsite = element(by.xpath('//*[@id="currentIhdPpmid_assetOnSite_n"]/span'));
 ...
 * @description PPMID section text display
***/
public async CurrentPPMIDSectiondispaly(){
    if (this.currentPPMIDText.isDisplayed()) {
        await this.currentPPMIDText.getText().then(function (currentPPMID) {
            console.log("find currentPPMID Text  " + currentPPMID);
        });
    }
}
...
***/
public async fillCurrentPPMIDSection(){
    if (this.PPMIDOnsite.isDisplayed()) {
        await this.PPMIDOnsite.click();
    }
    await utility.wait(5000);
}

public async fillCurrentPPMIDSectionYes(){
    await utility.wait(3000);
