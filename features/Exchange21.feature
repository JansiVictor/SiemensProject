...
# And "Appointment" ExTwOne details
# When I click on ExTwOne OK button  	
# And I should see ExTwOne ARRIVE button
# And I should see ExTwOne DOORSTEP PROTOCOL tab activated
...
# Then I should see ExTwOne GICOM Message section

# Scenario: Going through ExTwOne "GICOM Message" GAS section 
# Given the ExTwOne GICOM Message section 
# When I fill the ExTwOne GICOM Message section fields with values
...
# When I fill the ExTwOne configuration of all meters installed  fields with values
