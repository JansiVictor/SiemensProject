Feature: TST017_DFINST16
    ...
    Scenario: Going through "Post Installation GAS" GAS section for INST16GAS
        ...
        Then I should see GICOM Message section for INST16GAS

    Scenario: Going through "GICOM Message" GAS section for INST16GAS
        Given the GICOM Message section for INST16GAS
        When I fill the GICOM Message section fields with values for INST16GAS
